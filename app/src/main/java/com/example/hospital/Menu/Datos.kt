...
class Datos : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        val login = inflater.inflate(R.layout.fragment_datos, container, false)
        val actualizar: Button = login.findViewById(R.id.cargarInfo)
        val regresa: Button = login.findViewById(R.id.datosaMenu)
